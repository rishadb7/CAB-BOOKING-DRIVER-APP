...
public class BookingDetails {
    ...
    public BookingDetails(String date,String time,String pickUp,String vehicle,String riderPhone,String email,String status,String assignDriver)
    {
        this.date=date;
        this.time=time;
        this.pickUp=pickUp;
